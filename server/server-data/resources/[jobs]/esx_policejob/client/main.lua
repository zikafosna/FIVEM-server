...
--		table.insert(elements, {label = 'Police wear', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
		table.insert(elements, {label = 'SWAT Odelo', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	end
...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
		...
		if PlayerData.job.grade_name == 'boss' or 'captain' or 'dpchief' then
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions',
	{
		...
		elements = {
			...
			{label = "Poternica",               value = 'wanted_menu'}
		}
	}, function(data, menu)
