...
function CloseShop() {
    $("#shopmenu").hide();
    $(".wrapper").html('');
    $.post('http://almin_autosalon/CloseMenu', JSON.stringify({}));
}
...
$(document).ready(function(){
    ...
    $(".card-body").on('click', ':button', function () {
        $("#shopmenu").fadeOut();
        $.post('http://almin_autosalon/BuyVehicle', JSON.stringify({id: $(this).data('id')}));
    });
    ...
    $(".purchase").click( function() {
        CloseShop()
        $.post('http://almin_autosalon/BuyVehicle', JSON.stringify({ id: auta.cars[page]}));
    });
    $(".test").click( function() {
        CloseShop()
        $.post('http://almin_autosalon/Test', JSON.stringify({ id: auta.cars[page]}));
    });
