...
function OpenAdminActionMenu(player)
    ...
    ESX.TriggerServerCallback('esx_spec:getOtherPlayerData', function(data)
...
RegisterNetEvent('esx_spec:spectate')
AddEventHandler('esx_spec:spectate', function()
...
RegisterNUICallback('kick', function(data, cb)
	SetNuiFocus(false)
	TriggerServerEvent('esx_spec:kick', data.id, data.reason)
	TriggerEvent('esx_spec:spectate')
end)
